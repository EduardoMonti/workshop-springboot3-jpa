...
public class TestConfig implements CommandLineRunner {
	...
	// Injeção de dependencia dos repositories
	@Autowired
	...
	public void run(String... args) throws Exception {
		...
		/*
		 * Por ser uma associação  OneToOne não é necessário criar um repository do
		 * payment e sim salvar o orderRepository passando o pagamento
		 */
